...
const backtestTabs = computed(() => {
  ...
  tabs.push({
    ...
    label: t('backtest.analyzeResult'),
  ...
  if (hasMultiBacktestResult.value) {
    tabs.push({
      ...
      label: t('backtest.compareResults'),
  ...
  tabs.push({
    ...
    label: t('backtest.visualizeSummary'),
  ...
  tabs.push({
    ...
    label: t('backtest.visualizeResult'),
...
<template>
  <div class="flex flex-row pt-1 me-1 relative" style="height: calc(100vh - 60px)">
    ...
    <div class="flex flex-col w-full">
      <h2 class="ms-5 text-3xl font-bold">{{ $t('backtest.title') }}</h2>
