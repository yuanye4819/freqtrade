  ...
  <UTable :data="tableItems" :columns="columns">
    ...
    <template #profitOpen-cell="{ row }">
      <ProfitPill
        ...
        :profit-desc="`${$t('botComparison.totalProfitOpenRealized')} ${formatPercent(
