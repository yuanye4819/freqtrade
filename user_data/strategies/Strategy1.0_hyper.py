...
class Strategy1Hyper(IStrategy):
    """Strategy1.0 超参优化版"""
    ...
    # ====== 可优化参数 ======
    buy_rsi = IntParameter(15, 40, default=28, space="buy")
    buy_bb   = DecimalParameter(0.1, 0.5, default=0.3, decimals=2, space="buy")
    ...
    def plot_config(self):
        return {
            ...
            "subplots": {"RSI":{"rsi":{"color":"#ff0066"}},"MACD":{"macd":{"color":"blue"},"macdsignal":{"color":"orange"}},"Volume":{"volume":{"color":"#00ccff"}}}
        }
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["macd"] = macd["macd"]; dataframe["macdsignal"] = macd["macdsignal"]
